...
STATUS_MESSAGES = {
    ...
    StatusCode.JOIN_REQUEST_EXISTS: "Join request already exists and pending",
    StatusCode.INVALID_CLASS_CODE: "Invalid class code",
    StatusCode.CLASSROOM_NOT_FOUND: "Classroom not found",
    StatusCode.MESSAGE_NOT_FOUND: "Message context not found",
    StatusCode.DOCUMENT_ACCESS_DENIED: "Document access denied",
    StatusCode.EXAM_DELETED: "Exam has been deleted by teacher",

    StatusCode.OTP_INVALID: "Invalid OTP code",
    StatusCode.OTP_EXPIRED: "OTP code has expired",

    StatusCode.INTERNAL_SERVER_ERROR: "Internal server error",
    StatusCode.DATABASE_ERROR: "Database error",
    StatusCode.FILE_PROCESSING_ERROR: "File processing error",
    StatusCode.EXTERNAL_API_ERROR: "External service connection error",
    StatusCode.AI_GENERATION_FAILED: "Cannot generate questions from document",

    StatusCode.DOCUMENT_TOO_SHORT: "Document is too short to generate questions",
    StatusCode.DOCUMENT_INVALID_CONTENT: "Document content is invalid for question generation",
    StatusCode.DOCUMENT_INSUFFICIENT_FOR_QUESTIONS: "Document has insufficient content for requested questions",
}